<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taxClass.aspx.cs" Inherits="AspDotNetStorefrontAdmin.taxClass" Theme="default" %>
                ...
                <td>
                    <div class="wrapper">                       
                        <table border="0" cellpadding="0" cellspacing="0" class="innerTable" width="100%">
                            <tr>
                                <td class="titleTable">
                                    <font class="subTitle">Tax Classes:</font>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <asp:GridView Width="100%" ID="gMain" runat="server" PagerStyle-HorizontalAlign="left" PagerSettings-Position="TopAndBottom" AutoGenerateColumns="False" AllowPaging="true" PageSize="15" AllowSorting="True" CssClass="overallGrid" HorizontalAlign="Left" OnRowCancelingEdit="gMain_RowCancelingEdit" OnRowCommand="gMain_RowCommand" OnRowDataBound="gMain_RowDataBound" OnSorting="gMain_Sorting" OnPageIndexChanging="gMain_PageIndexChanging" OnRowUpdating="gMain_RowUpdating" OnRowEditing="gMain_RowEditing">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="TaxClassID" HeaderText="ID" ReadOnly="True" SortExpression="TaxClassID" ItemStyle-CssClass="lighterData" />
                                                ...
                                                <asp:TemplateField HeaderText="Tax Code" SortExpression="TaxCode" ItemStyle-CssClass="lighterData">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-CssClass="selectData" ItemStyle-Width="25">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgDelete" CommandName="DeleteItem" CommandArgument='<%# Eval("TaxClassID") %>' runat="Server" AlternateText="Delete" ImageUrl="icons/delete.gif" />                                                        
                                                    </ItemTemplate>
                                                </asp:TemplateField>
