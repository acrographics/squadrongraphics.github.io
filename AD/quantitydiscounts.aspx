<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quantitydiscounts.aspx.cs" Inherits="quantitydiscounts" Theme="default" %>
                                    ...
                                    <div class="wrapperLeft">
                                        <asp:PlaceHolder ID="phMain" runat="server">
                                            ...
                                            <div style="width: 100%; text-align: left; padding-left: 145px;">
                                                &nbsp;&nbsp;<asp:Button ID="btnSubmit" CssClass="normalButton" runat="server" OnClick="btnSubmit_Click" />
                                                &nbsp;&nbsp;<asp:Button ID="btnDelete" CssClass="normalButton" runat="server" OnClick="btnDelete_Click" Text="Delete Discount Table" />
                                            </div>
                                            ...
                                            <div style="width: 100%; text-align: left;" runat="server" id="divGrid">
                                                    ...
                                                    <table width="100%" cellpadding="1" cellspacing="0" border="0">
                                                        <tr id="tr1" runat="server">
                                                            ...
                                                            <td align="left" valign="top">
                                                                ...
                                                                <asp:RangeValidator ID="RangeValidatorIni3" runat="server" ControlToValidate="txtPercent1" ErrorMessage="Invalid Percent" Type="double" MinimumValue="0" MaximumValue="100"></asp:RangeValidator>
                                                            </td>
                                                        </tr>
                                                        <tr id="tr2" runat="server">
                                                            ...
                                                            <td align="left" valign="top">
                                                                ...
                                                                <asp:RangeValidator ID="RangeValidator5" runat="server" ControlToValidate="txtPercent2" ErrorMessage="Invalid Percent" Type="double" MinimumValue="0" MaximumValue="100"></asp:RangeValidator>
                                                            </td>
                                                        </tr>
                                                        <tr id="tr3" runat="server">
                                                            ...
                                                            <td align="left" valign="top">
                                                                ...
                                                                <asp:RangeValidator ID="RangeValidator8" runat="server" ControlToValidate="txtPercent3" ErrorMessage="Invalid Percent" Type="double" MinimumValue="0" MaximumValue="100"></asp:RangeValidator>
                                                            </td>
                                                        </tr>
                                                        <tr id="tr4" runat="server">
                                                            ...
                                                            <td align="left" valign="top">
                                                                ...
                                                                <asp:RangeValidator ID="RangeValidator11" runat="server" ControlToValidate="txtPercent4" ErrorMessage="Invalid Percent" Type="double" MinimumValue="0" MaximumValue="100"></asp:RangeValidator>
                                                            </td>
                                                        </tr>
                                                        <tr id="tr5" runat="server">
                                                            ...
                                                            <td align="left" valign="top">
                                                                ...
                                                                <asp:RangeValidator ID="RangeValidator14" runat="server" ControlToValidate="txtPercent5" ErrorMessage="Invalid Percent" Type="double" MinimumValue="0" MaximumValue="100"></asp:RangeValidator>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                ...
                                                <asp:GridView Width="100%" ID="gMain" runat="server" AutoGenerateColumns="False" CssClass="overallGrid" HorizontalAlign="Left" OnRowCancelingEdit="gMain_RowCancelingEdit" OnRowCommand="gMain_RowCommand" OnRowDataBound="gMain_RowDataBound" OnRowUpdating="gMain_RowUpdating" OnRowEditing="gMain_RowEditing">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Discount Percent" SortExpression="DiscountPercent" ItemStyle-CssClass="normalData">
                                                            <ItemTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                ...
                                                                ex: 12.75
                                                                <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtPercent" ErrorMessage="Invalid Percent" Type="double" MinimumValue="0" MaximumValue="100"></asp:RangeValidator>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>                                             
                                                        <asp:TemplateField ItemStyle-CssClass="selectData" ItemStyle-Width="25">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="imgDelete" CommandName="DeleteItem" CommandArgument='<%# Eval("QuantityDiscountTableID") %>' runat="Server" AlternateText="Delete" ImageUrl="icons/delete.gif" />                                                        
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
