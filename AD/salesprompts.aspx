<%@ Page Language="C#" AutoEventWireup="true" CodeFile="salesprompts.aspx.cs" Inherits="AspDotNetStorefrontAdmin.salesprompts" Theme="default" %>
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <asp:GridView Width="100%" ID="gMain" runat="server" PagerStyle-HorizontalAlign="left" PagerSettings-Position="TopAndBottom" AutoGenerateColumns="False" AllowPaging="true" PageSize="15" AllowSorting="True" CssClass="overallGrid" HorizontalAlign="Left" OnRowCancelingEdit="gMain_RowCancelingEdit" OnRowCommand="gMain_RowCommand" OnRowDataBound="gMain_RowDataBound" OnSorting="gMain_Sorting" OnPageIndexChanging="gMain_PageIndexChanging" OnRowUpdating="gMain_RowUpdating" OnRowEditing="gMain_RowEditing">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="SalesPromptID" HeaderText="ID" ReadOnly="True" SortExpression="SalesPromptID" ItemStyle-CssClass="lighterData" />
                                                <asp:TemplateField HeaderText="Sales Prompt" SortExpression="Name" ItemStyle-CssClass="normalData">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-CssClass="selectData" ItemStyle-Width="25">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgDelete" CommandName="DeleteItem" CommandArgument='<%# Eval("SalesPromptID") %>' runat="Server" AlternateText="Delete" ImageUrl="icons/delete.gif" />                                                        
                                                    </ItemTemplate>
                                                </asp:TemplateField>
