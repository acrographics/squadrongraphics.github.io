...
// $Header: /v6.2/Web/Admin/EntityProductImageMgr.aspx.cs 3     9/30/06 3:38p Redwoodtree $
// ------------------------------------------------------------------------------------------
using System;
using System.Data;
    ...
    public partial class EntityProductImageMgr : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (CommonLogic.FormBool("IsSubmit"))
            {
                        ...
                        if (FieldName.IndexOf("Key_") != -1)
                        {
                            ...
                            if (Image2File.ContentLength != 0)
                            {
                                ...
                                if (TheSize == "large")
                                {
                                    ...
                                    bool globalCreate = AppLogic.AppConfigBool("LargeCreatesOthers");
                                    bool globalOverwrite = AppLogic.AppConfigBool("LargeOverwritesOthers");
                ...
                IDataReader rsColors = DB.GetRS("select Colors from productvariant  " + DB.GetNoLock() + " where VariantID=" + VariantID.ToString());
                if (!rsColors.Read())
                {
                    rsColors.Close();
                }
                ...
                {
                    AppLogic.MakeColorSwatch(ProductID,skinID,ThisCustomer.LocaleSetting,variantColors);
                }
        ...
        protected void LoadData()
        {
            ...
            temp += ("</table>\n");
            temp += ("<p align=\"left\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"submit\" value=\"Update\" name=\"submit\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"reset\" value=\"Reset\" name=\"reset\"></p>\n");
            temp += ("</form>\n");
            temp += ("</div>");
            rs.Close();
