    ...
    <form id="Form1" runat="server">
        ...
        <asp:Panel ID="pnlAddress" runat="server" Visible="true">
            <asp:Table ID="tblAddressList" CellSpacing="0" CellPadding="2" Width="100%" runat="server">
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="center"><asp:Button ID="btnValidateAddress" runat="server" visible="false" CssClass="EditAddressButton" OnClick="btnValidateAddress_Click" /><asp:Label ID="lblValidateAddressSpacer" Text="&nbsp;&nbsp;&nbsp;&nbsp;" runat="server"></asp:Label><asp:Button ID="btnSaveAddress" runat="server" CssClass="EditAddressButton" OnClick="btnSaveAddress_Click" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnDeleteAddress" runat="server" CssClass="EditAddressButton" OnClick="btnDeleteAddress_Click" /></asp:TableCell> 
                </asp:TableRow>
            </asp:Table>
            <br/>
            <br/>
