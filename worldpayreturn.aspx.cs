...
// $Header: /v6.2/Web/worldpayreturn.aspx.cs 13    9/30/06 3:38p Redwoodtree $
// ------------------------------------------------------------------------------------------
using System;
using System.Web;
...
namespace AspDotNetStorefront
{
    ...
    public partial class worldpayreturn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            bool NoAutoRefresh = CommonLogic.QueryStringCanBeDangerousContent("refresh").ToUpperInvariant() == "FALSE";
            ...
            else
            {
                ...
                if (CustomerID != 0)
                {
                    ...
                    if (status.ToUpperInvariant() != AppLogic.ro_OK)
                    {
