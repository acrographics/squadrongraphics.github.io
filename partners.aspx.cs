...
// $Header: /v6.2/Web/partners.aspx.cs 2     7/19/06 11:13p Redwoodtree $
// ------------------------------------------------------------------------------------------
using System;
using System.Web;
using System.Data;
...
namespace AspDotNetStorefront
{
	...
	/// </summary>
	public partial class partners : SkinBase
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            SectionTitle = AppLogic.GetString("partners.aspx.1", SkinID, ThisCustomer.LocaleSetting);
