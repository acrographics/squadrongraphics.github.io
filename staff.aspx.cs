...
// $Header: /v6.2/Web/staff.aspx.cs 2     7/19/06 11:13p Redwoodtree $
// ------------------------------------------------------------------------------------------
using System;
using System.Web;
...
namespace AspDotNetStorefront
{
	...
	/// </summary>
	public partial class staff : SkinBase
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            SectionTitle = AppLogic.GetString("staff.aspx.1", SkinID, ThisCustomer.LocaleSetting);
